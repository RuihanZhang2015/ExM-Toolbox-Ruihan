...
fov_code_pairs = [[fov,code] for fov in [16] for code in range(7)]
exseq.extract(fov_code_pairs,num_cpu = 6)
exseq.consolidate_channels(fov_code_pairs)
exseq.consolidate_codes([16],codes=range(7))