...
class sitkTile:
    ...
    def computeTransformMap(self, fix_dset, move_dset, initial_transform_file=None, 
        ...
        if initial_transform_file:
            self.elastix.SetInitialTransformParameterFileName(initial_transform_file)
...
#         tform = align.readTransformMap(args['out_dir'] + 'code{}/tforms/{}.txt'.format(code,fov))
#         self.transformix.SetTransformParameterMap(transform_map)
        
#         pts_um = raw_data.getViewPixPosition(vid)[::-1] * res
#         shift_local_um = -pad_half * res
#         trans_um = trans0_um.copy()
#         trans_um[9:] = shift_local_um
#         transform_local = sitk.ReadParameterFile(args['out_dir'] + 'code{}/tforms/{}.txt'.format(code,fov))
